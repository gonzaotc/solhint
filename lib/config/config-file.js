...
// `require(esm)` (Node >= 22.12) returns a module namespace rather than the exported object.
// Unwrap it so that a config authored as ESM reaches the validator in the shape it expects.
